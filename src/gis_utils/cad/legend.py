...
reuse the emitter's :class:`~gis_utils.cad.styles.Style` so a legend swatch is
...
re-export (:func:`gis_utils.cad.emit.export_layers`) clears the legend together
...
from gis_utils.cad.emit import _add_hatch, _attach_provenance, _polygon_rings
from gis_utils.cad.styles import Style
