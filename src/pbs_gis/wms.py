...
CLI: conda activate gis && python -m pbs_gis.wms_to_shape --input-boundary input/area.shp --output Shapes/out.shp [options]

Library (no defaults — you must specify extent or input_boundary, and one of line_color, line_color_rgb, or line_channel):
  from pathlib import Path
  from pbs_gis.wms_to_shape import run, get_bounds_from_shape
