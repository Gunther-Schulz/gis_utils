...
schema_version 1).  pbs_gis is the *producer*; pbs-projekt is the *consumer*
...
def werkzeug_id(producer: str) -> str:
    """Build the ``werkzeug`` diagnostic string: ``pbs_gis/<version> (<producer>)``.
